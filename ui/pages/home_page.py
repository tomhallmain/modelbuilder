...
class HomePage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self._bullet_export = QLabel()
        summary_layout.addWidget(self._bullet_export)
        self._bullet_evaluate = QLabel()
        summary_layout.addWidget(self._bullet_evaluate)
        ...
        self._btn_export.clicked.connect(
            lambda checked=False, r=ModelBuilderTaskType.EXPORT.nav_row_index: self._open_nav_row(r)
        )
        quick_layout.addWidget(self._btn_export)
        self._btn_evaluate = QPushButton()
        self._btn_evaluate.clicked.connect(
            lambda checked=False, r=ModelBuilderTaskType.EVALUATE.nav_row_index: self._open_nav_row(r)
        )
        quick_layout.addWidget(self._btn_evaluate)
    ...
    def retranslate_ui(self) -> None:
        ...
        self._btn_export.setText(_("Open Export Page"))
        self._btn_evaluate.setText(_("Open Evaluate Page"))
